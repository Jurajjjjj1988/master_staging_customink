...
// ---------------------------------------------------------------------------
// 5c. FOOTER NAVIGATION + 5d. FOLLOW US — extracted to
// `tests/footer-links.spec.ts`. The two parameterized loops over
// FOOTER_LINKS (×16) + FOLLOW_US_LINKS (×6) generate 22 tests on their
// own and are structurally independent of the per-state header journeys.
